...
Версия 1.3a
Selenium заменен на асинхронный playwright. Для каждого отдельного слежения запускается один асинхронный браузер, но с отдельным изолированным контекстом для каждой сессии.
