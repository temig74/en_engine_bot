...
- Скачать последнюю скомпилированную в exe версию из релизов (нужна win >=10): https://github.com/temig74/en_engine_bot/releases или запускать из исходников через питон, установив все необходимые библиотеки (aiogram, lxml, playwright (и playwright install firefox\chromium (какой браузер использовать можно указать в en_settings.ini)), BeautifulSoup4), использовалась версия питона 3.12
