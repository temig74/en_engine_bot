...
# далее команды бота
@dp.message(CmdFilter(['help', 'start'], None))
...
@dp.message(CmdFilter(['scr', 'скр', 'screen', 'скрин', 'fs', 'фс'], None))
...
@dp.message(CmdFilter(['h', 'hints'], None))
...
@dp.message(CmdFilter(['time'], None))
...
@dp.message(CmdFilter(['load_old_json'], None))
...
@dp.message(CmdFilter(['game_info'], None))
...
@dp.message(CmdFilter(['levels'], None))
